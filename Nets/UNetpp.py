...
class NestedUNet(nn.Module):
    def __init__(self, num_classes, input_channels=3, deep_supervision=False, **kwargs):
        ...
        if self.deep_supervision:
            ...
            self.final = nn.Conv2d(nb_filter[0], num_classes, kernel_size=3, padding=1)

        print("Unetpp_2D has been made ----depths:{};num_classes:{}".format(4, 2))
...
if __name__ == '__main__':
    ...
    model = NestedUNet(num_classes=3, input_channels=3).to(device)
