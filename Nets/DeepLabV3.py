...
class DeepLabV3(nn.Module):
    ...
    def forward(self, rbg):
        ...
        rgb_x21 = self.relu(self.bn1(self.conv1(main_aspp)))
        rgb_x21 = self.conv2(rgb_x21)
...
if __name__ == '__main__':
    ...
    model = DeepLabV3(num_classes=3, co_branch_rate=0.0).to(device)
